...
/**
 * @author usuario <br>
 *         Interfaz con los metodos necesarios para poder realizar la
 *         persistencia del sistema<br>
 * @param <E> de tipo Serializable y sera el objeto que representa a nuestro
 *            sistema
 */
