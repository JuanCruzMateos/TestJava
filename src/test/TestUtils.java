...
public class TestUtils {
	 ...
	 * contenedor discriminado por su nombre Si el componente no se encuentra, se
	 * devuelve null
	 * 
	...
	/**
	 * Metodo que tipea un texto utilizando la clase Robot. Solo se aplica a textos
	 * que contengan letras de la 'a' a la 'z', tanto mayusculas como minusculas.
	 * 
