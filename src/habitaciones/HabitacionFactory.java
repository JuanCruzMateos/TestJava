...
/**
 * @author Clase Factory en donde se generaran las distintas habitaciones :
 *         Habitacion Compartida, Habitacion Privada y Sala de Terapia
 *         Intensiva<br>
 */
public class HabitacionFactory {
	 ...
	 * 
	 * @param tipo : parametro de tipo string el cual contiene el tipo de habitacion
	 *             que se va a instanciar<br>
	 * @return se crea una habitacion del tipo ingresado<br>
	 * @throws TipoHabitacionInvalidaException : lanza una excepci�n informando al
	 *                                         usuario que la habitacion ingresada
	 *                                         es nula o erronea
	 */
